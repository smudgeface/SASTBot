...
| Side ✅ | `main` (see PROGRESS.md 2026-05-22) | 0.8.0 (no bump) | scans routes (`DELETE /api/scans/:id`), scanService (`deleteScanRun`, `ScanIsCurrentLatestError`, `ScanStillRunningError`), `backend/tests/scansDelete.test.ts` |
